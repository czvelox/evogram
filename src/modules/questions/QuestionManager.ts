...
import { questionsHandler } from "./questionsHandler";

export class QuestionManager {
	constructor(client: Evogram) {
		client.updates.on("message", questionsHandler);
	}
	 ...
	 * @param {boolean} deleteQuestion - Optional flag that indicates if the question should be removed from the waiting object. Defaults to true.
